...
import { LuUsers, LuCalendar, LuVote } from "react-icons/lu"

export const metadata: Metadata = {
  title: "Dashboard",
  description: "Voter Management System Dashboard",
}
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <LuVote className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">78%</div>
            <p className="text-xs text-muted-foreground">+2.3% from last election</p>
          </CardContent>
        </Card>
      </div>
